...
@section('content')
    ...
    <div class="d-flex justify-content-center mt-5">
        ...
        <div class="card shadow p-4 rounded-4" style="width: 420px; border: none;">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control rounded-3 py-2" placeholder="Enter your full name"
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" class="form-control rounded-3 py-2" placeholder="Enter your email"
                        required style="border: 1px solid #c6d5c2;">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="phone" class="form-control rounded-3 py-2" placeholder="012-3456789" required
                ...
                <div class="mb-3">
                    ...
                    <textarea name="address" class="form-control rounded-3 py-2" placeholder="Enter your address" rows="2"
                        style="border: 1px solid #c6d5c2;"></textarea>
                </div>
