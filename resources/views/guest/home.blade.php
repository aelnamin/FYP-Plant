...
@push('head')
    <link rel="preload" as="image" type="image/webp" href="{{ asset('images/hero-plant-1280.webp') }}"
        ...
        <section class="home-hero" aria-labelledby="home-hero-title">
            <div id="plantBanner" class="carousel slide home-hero__carousel" data-bs-ride="carousel" data-bs-interval="5000">
                <div class="carousel-indicators">
                    <button type="button" data-bs-target="#plantBanner" data-bs-slide-to="0" class="active" aria-current="true"
                        aria-label="Show indoor plants"></button>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img src="{{ asset('images/hero-essentials-1280.webp') }}"
                            ...
                            sizes="100vw" width="1537" height="1023" class="home-hero__image"
                            alt="Plant and gardening essentials from trusted sellers" loading="lazy" fetchpriority="low"
                            decoding="async">
                    </div>
                </div>
            </div>
    ...
    <div class="container py-4">
        ...
        <div class="d-flex flex-wrap gap-3 justify-content-center mb-5">
            ...
            <a href="{{ route('products.browse', request()->except('category')) }}" class="text-decoration-none text-dark">
                ...
                <div class="category-card text-center p-3 shadow-sm rounded-4">
                    <img src="{{ asset('images/all-products.png') }}" alt="All Categories" class="category-img" width="48"
