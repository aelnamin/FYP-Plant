...
@section('content')
    ...
    @if($product->stock_quantity <= 10)
        <span class="text-danger ms-1 small" title="Low Stock">
            <i class="bi bi-exclamation-triangle-fill me-1" style="font-size: 0.8rem;"></i> Low
        </span>
    @endif
</td>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <span class="badge bg-success py-1 px-3">Approved</span> <!-- optional fallback -->
                                                @endif
                                            </td>
