    ...
    <div class="container mt-4">
        ...
        <div class="card p-4">
            ...
            @foreach($product->images as $img)
                <img src="{{ asset('images/' . $p->images->first()->image_path) }}" width="150" class="me-2 mb-3 rounded">
            @endforeach

            <div class="mt-3">
                <a href="{{ route('sellers.inventory.edit', $product->id) }}" class="btn btn-warning">Edit</a>
                <a href="{{ route('sellers.inventory.index') }}" class="btn btn-secondary">Back</a>
            </div>
