...
@section('content')
    <div class="container mx-auto px-4 py-8 bg-gray-50">
        ...
        @else
            ...
            <!-- Updated Growth Log Form - Leaf Count Removed -->
            <div id="growth-form-container" class="hidden mb-8 card bg-white rounded-xl p-6 shadow-md">
                ...
                <form id="growth-log-form" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="growth_stage" required class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                    ...
                    <div class="mt-4 flex justify-end space-x-3">
                        <button type="button" onclick="hideForm('growth-form-container')"
            ...
            <!-- Updated Care Log Form -->
            <div id="care-form-container" class="hidden mb-8 card bg-white rounded-xl p-6 shadow-md">
                ...
                <form id="care-log-form" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="care_type" required class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                    ...
                    <div class="mt-4 flex justify-end space-x-3">
                        <button type="button" onclick="hideForm('care-form-container')"
                            class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                            Cancel
                        </button>
            ...
            <div id="default-content" class="text-center py-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                        ...
                        <p class="text-gray-600 text-sm">Monitor height and growth stages</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
