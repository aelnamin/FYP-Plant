...
<div class="row">
        ...
        <div class="card shadow-sm rounded p-3 mb-3">
            ...
            <div class="row g-3">
                ...
                <div class="col-6 col-md-4">
                    <div class="d-flex">
                        <img src="{{ $p->images->first() ? asset('storage/' . $p->images->first()->image_path) : asset('images/default.jpg') }}"
                            class="rounded"
    ...
    <div class="col-md-4">
        <div class="card shadow-sm rounded p-3 mb-3">
            <h6>Quick Actions</h6>
            <a href="{{ route('sellers.inventory.index') }}" class="btn btn-outline-success w-100 mb-2">Manage Products</a>
            <a href="{{ route('sellers.inventory.create') }}" class="btn btn-outline-primary w-100">Add New Product</a>
        </div>
    </div>
</div>
